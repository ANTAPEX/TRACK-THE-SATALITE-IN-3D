...
Applications that track the Satalites are easy to find online, but their features and capabilities vary. Our challenge is to build and publish an open-source web application that tracks the space station in three dimensions.

### <code>Background</code>
<!-- There are few or no websites that can show or deploy the NIGSAT in the Earth's orbit, 
